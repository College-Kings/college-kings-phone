screen tracker_home():
    ...
    python:
        ...
        TrackerData(amber, ViewedScene.V1_AMBER in viewed_scenes, _("• I let Amber do drugs and had sex."))
        TrackerData(amber, ViewedScene.V2_AMBER in viewed_scenes, _("• Amber gave me a blowjob at Lauren's party."))
        ...
        TrackerData(aubrey, ViewedScene.CK1_V11_AUBREY in viewed_scenes, _("• Aubrey and I became FWB."))
        ...
        TrackerData(aubrey, ViewedScene.CK1_V14_THREESOME in viewed_scenes, _("• I had a threesome with Riley and Aubrey."))
        ...
        TrackerData(aubrey, ViewedScene.V2_AUBREY in viewed_scenes, _("• I fingered Aubrey at Lauren's party."))
        ...
        TrackerData(autumn, ViewedScene.V2_AUTUMN in viewed_scenes, _("• Autumn and I kissed at Lauren's party."))
        ...
        TrackerData(chloe, ViewedScene.V1_CHLOE in viewed_scenes, _("• I had sex with Chloe in the school parking lot."))
        ...
        TrackerData(chloe, ViewedScene.V3_CHLOE in viewed_scenes, _("• Chloe and I were bad parents and had sex."))
        ...
        TrackerData(emily, ViewedScene.V2_EMILY in viewed_scenes, _("• I sexted with Emily."))
        TrackerData(emily, ViewedScene.V3_EMILY in viewed_scenes, _("• Emily showed off her new lingerie on webcam."))

        TrackerData(jenny, ViewedScene.V1_JENNY in viewed_scenes, _("• I had sex with Jenny at the lagoon."))
        ...
        TrackerData(lauren, ViewedScene.CK1_V12_LAUREN in viewed_scenes, _("• I slept with Lauren for the first time in Europe."))
        ...
        TrackerData(lauren, ViewedScene.V2_LAUREN in viewed_scenes and not v2s18e_cum_in_lauren, _("• I had sex with Lauren at her party."))
        TrackerData(lauren, ViewedScene.V2_LAUREN in viewed_scenes and v2s18e_cum_in_lauren, _("• I had sex with Lauren at her party and came inside her."))
        TrackerData(lauren, ViewedScene.V3_LAUREN in viewed_scenes, _("• Lauren gave me a handjob during Ms. Rose's class."))
        ...
        TrackerData(ms_rose, ViewedScene.V2_ROSE in viewed_scenes, _("• I had sex again with Ms. Rose."))
        ...
        TrackerData(naomi, ViewedScene.V2_NAOMI in viewed_scenes, _("• Naomi gave me a blowjob at her parents' wedding."))
        ...
        TrackerData(nora, ViewedScene.CK1_V12_NORA in viewed_scenes, _("• I slept with Nora in Europe."))
        ...
        TrackerData(nora, ViewedScene.V2_NORA in viewed_scenes, _("• I slept with Nora at her dad's cabin."))
        TrackerData(nora, v2_nora_cum, _("• I came inside Nora."))
        TrackerData(nora, ViewedScene.V3_NORA in viewed_scenes, _("• I fingered Nora during her massage."))

        TrackerData(riley, ViewedScene.CK1_V14_THREESOME in viewed_scenes, _("• I had a threesome with Riley and Aubrey."))
        TrackerData(riley, ViewedScene.V2_RILEY in viewed_scenes, _("• Riley gave me a handjob at Lauren's party."))
        TrackerData(riley, (CharacterService.is_fwb(riley)), _("• I agreed with Riley - Polygamy is the way."))
        TrackerData(riley, ViewedScene.V3_RILEY in viewed_scenes, _("• Riley gave me a blowjob after my fight with Tom."))
        ...
        TrackerData(penelope, ViewedScene.V2_PENELOPE in viewed_scenes, _("• I went down on Penelope at Lauren's party."))
        TrackerData(penelope, v1_penelope_date, _("• Penelope and I went on a dinner date."))
        TrackerData(penelope, ViewedScene.V3_PENELOPE in viewed_scenes, _("• Penelop and I had sex while dog sitting."))
        ...
        TrackerData(samantha, ViewedScene.V1_SAMANTHA in viewed_scenes, _("• I slept with Samantha."))
        ...
        vpgrid:
            ...
            for npc in sorted(set(data.character for data in TrackerData.data), key=lambda npc: npc.name):
                imagebutton:
                    ...
                    action Show("tracker_choices", npc=npc)


screen tracker_choices(npc):
    tag phone_tag
    modal True
